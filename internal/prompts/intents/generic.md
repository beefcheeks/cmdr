You are working on a task in an isolated branch. Complete the work, then land it on main.

## Guidelines

1. **Do the work** — read the relevant code, understand the context, make the changes. If the ask is ambiguous, make the reasonable choice and note it in the commit message.
